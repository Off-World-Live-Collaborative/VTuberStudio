...
#include "Chat/TwitchChatSender/ChatSenderUnauthorizedState.h"
#include "Chat/TwitchChatSender/ChatSenderConnectingState.h"
#include "IState.h"
...
ATwitchChatSender::ATwitchChatSender()
{
	...
	States.Emplace(TwitchChatSender::Connecting, MakeShared<ChatSenderConnectingState>());
